...
use super::{
    ...
    overlays::{
        BallDetection, BallSearchHeatmap, FeetDetection, FieldBorder, Horizon, LimbProjector,
...
pub struct Overlays {
    ...
    pub ball_search_heatmap: EnabledOverlay<BallSearchHeatmap>,
}
...
impl Overlays {
    pub fn new(nao: Arc<Nao>, storage: Option<&Value>, selected_cycler: VisionCycler) -> Self {
        ...
        let ball_search_heatmap = EnabledOverlay::new(nao, storage, false, selected_cycler);
    ...
    pub fn update_cycler(&mut self, selected_cycler: VisionCycler) {
        ...
        self.ball_search_heatmap.update_cycler(selected_cycler);
    }
    ...
    pub fn combo_box(&mut self, ui: &mut Ui, selected_cycler: VisionCycler) {
        ui.menu_button("Overlays", |ui| {
            ...
            self.ball_search_heatmap.checkbox(ui, selected_cycler);
        });
    }
    ...
    pub fn paint(&mut self, painter: &TwixPainter<Pixel>) {
        ...
        self.ball_search_heatmap.paint(painter);
    }
